...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: Encryption_Core_0, and set properties
	set Encryption_Core_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Encryption_Core:1.0 Encryption_Core_0 ]
	...
	# Connect all clock & reset of Encryption_Core_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins Encryption_Core_0/data_in]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins Encryption_Core_0/key_in]
	connect_bd_net [get_bd_pins Encryption_Core_0/key_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Encryption_Core_0/key_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of Encryption_Core_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins Encryption_Core_0/data_out]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_out_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_out_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins Encryption_Core_0/data_out_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of Encryption_Core_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {Encryption_Core_0/data_out/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_data_out_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells Encryption_Core_0]

	# Copy all address to Encryption_Core_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/Encryption_Core_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Encryption_Core_0_data_in_* ]]
	puts $fp "set data_in_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Encryption_Core_0_key_in_* ]]
	puts $fp "set key_in_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:Encryption_Core:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/Encryption_Core_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "Encryption_Core_v1_0_hw_${i}"
